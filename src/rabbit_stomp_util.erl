...
build_argument(?HEADER_X_DEAD_LETTER_ROUTING_KEY, Val) -> {list_to_binary(?HEADER_X_DEAD_LETTER_ROUTING_KEY), longstr, list_to_binary(string:strip(Val))};
build_argument(?HEADER_X_EXPIRES, Val) -> {list_to_binary(?HEADER_X_EXPIRES), long, list_to_integer(string:strip(Val))};
build_argument(?HEADER_X_MAX_LENGTH, Val) -> {list_to_binary(?HEADER_X_MAX_LENGTH), long, list_to_integer(string:strip(Val))};
build_argument(?HEADER_X_MAX_LENGTH_BYTES, Val) -> {list_to_binary(?HEADER_X_MAX_LENGTH_BYTES), long, list_to_integer(string:strip(Val))};
build_argument(?HEADER_X_MAX_PRIORITY, Val) -> {list_to_binary(?HEADER_X_MAX_PRIORITY), long, list_to_integer(string:strip(Val))};
build_argument(?HEADER_X_MESSAGE_TTL, Val) -> {list_to_binary(?HEADER_X_MESSAGE_TTL), long, list_to_integer(string:strip(Val))}.
